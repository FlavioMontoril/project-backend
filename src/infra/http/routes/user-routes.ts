...
import * as findAllUsersWithHasTasksOpenController from "@/infra/controller/user-controller.ts/find-all-users-with-has-tasks-open-controller.js"
...
.get('/hasOpen', ensureAuthenticated, findAllUsersWithHasTasksOpenController.default.handle)